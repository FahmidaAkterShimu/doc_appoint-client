            ...
            <section className='bg-slate-50 py-16'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-3 gap-8'>
                        <div className='relative bg-white rounded-2xl p-7 border border-slate-100 shadow-sm'>
                            <span className='absolute top-4 right-4 text-5xl font-serif text-slate-100 select-none'>
                                01
                            </span>
